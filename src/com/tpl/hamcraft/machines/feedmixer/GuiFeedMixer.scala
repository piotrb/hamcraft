...
import com.tpl.hamcraft.gui.{WidgetPowerCustom, Textures, WidgetProgressBarNEI}
...
class GuiFeedMixer(val te: TileFeedMixer, player: EntityPlayer) extends BaseScreen(new ContainerFeedMixer(te, player), 176, 166) {
  ...
  override def initGui() {
    super.initGui()
    widgets.add(new WidgetProgressBarNEI(new Rect(84, 18, 66, 15), Textures.whiteProgress(66), te.progress, "Feed Mixer"))
