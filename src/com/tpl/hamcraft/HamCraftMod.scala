...
@Mod(modid = "HamCraft", name = "H-A-M Craft", version = "HAMCRAFT_VERSION", modLanguage = "scala", dependencies = "required-after:ThermalExpansion@(3.0,);required-after:bdlib@(1.0,)")
